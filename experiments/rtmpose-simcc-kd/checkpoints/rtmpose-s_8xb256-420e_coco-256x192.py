...
custom_hooks = [
    dict(
        ema_type="ExpMomentumEMA", momentum=0.0002, priority=49, type="EMAHook", update_buffers=True
    ),
    dict(
        switch_epoch=390,
        switch_pipeline=[
...
default_hooks = dict(
    ...
    checkpoint=dict(
        interval=10, max_keep_ckpts=1, rule="greater", save_best="coco/AP", type="CheckpointHook"
    ),
...
test_evaluator = dict(
    ann_file="data/coco/annotations/person_keypoints_val2017.json", type="CocoMetric"
)
