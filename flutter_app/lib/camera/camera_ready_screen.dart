                            ...
                            children: [
                              if (ble.leftDevice != null)
                                Chip(
                                  ...
                                  label: Text(
                                    'Левый ${ble.leftDevice!.isConnected ? "✓" : "…"}',
                                    style: const TextStyle(fontSize: 10),
                                  ),
                                  backgroundColor: ble.leftDevice!.isConnected
                              ...
                              if (ble.rightDevice != null)
                                Chip(
                                  ...
                                  padding: EdgeInsets.zero,
                                  label: Text(
                                    'Правый ${ble.rightDevice!.isConnected ? "✓" : "…"}',
                                    style: const TextStyle(fontSize: 10),
                                  ),
                                  backgroundColor: ble.rightDevice!.isConnected
                                      ? Colors.green.shade800
                                      : Colors.orange.shade800,
                                ),
                            ],
                    ...
                    ListTile(
                      ...
                      trailing: DropdownButton<ResolutionPreset>(
                        ...
                        items: ResolutionPreset.values.map((r) {
                          final label = {
                            ResolutionPreset.low: 'Низкое',
                            ResolutionPreset.medium: 'Среднее',
                            ResolutionPreset.high: 'Высокое',
                            ResolutionPreset.veryHigh: 'Очень высокое',
