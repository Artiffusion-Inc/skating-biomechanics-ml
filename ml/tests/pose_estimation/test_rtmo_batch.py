...
class TestPreprocessBatch:
    def test_output_shape(self):
        ...
        tensor, ratios = preprocess_batch(frames)
    ...
    def test_ratio_for_square_frame(self):
        ...
        _tensor, ratios = preprocess_batch([frame])
        assert ratios[0] == 1.0
    ...
    def test_padding_is_gray(self):
        ...
        tensor, _ = preprocess_batch([frame])
    ...
    def test_single_frame(self):
        ...
        tensor, _ratios = preprocess_batch([frame])
...
class TestPostprocessBatch:
    def test_no_detections(self):
        ...
        results = postprocess_batch(dets, keypoints, [1.0, 1.0])
    ...
    def test_single_detection_passes_nms(self):
        ...
        results = postprocess_batch(dets, keypoints, [1.0], score_thr=0.3)
    ...
    def test_ratio_rescales_keypoints(self):
        ...
        results = postprocess_batch(dets, keypoints, [ratio], score_thr=0.3)
        kp, _ = results[0]
