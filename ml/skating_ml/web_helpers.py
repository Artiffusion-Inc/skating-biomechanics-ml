...
def process_video_pipeline(  # noqa: PLR0913
    ...
    from skating_ml.visualization import render_layers
    from skating_ml.visualization.pipeline import VizPipeline, prepare_poses
    ...
    if any_ml:
        ...
        if matting and registry.is_registered("video_matting"):
            from skating_ml.extras.video_matting import VideoMatting
        ...
        if inpainting and seg_est is not None and registry.is_registered("lama"):
            from skating_ml.extras.inpainting import ImageInpainter
